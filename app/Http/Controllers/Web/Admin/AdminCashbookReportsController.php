...
class AdminCashbookReportsController extends Controller
{
    ...
    {
        return app(DailyInventoryComparisonService::class)->sortComparisonRows($rows, $sortBy, $sortDir);
    }
    ...
    {
        return app(DailyInventoryComparisonService::class)->buildComparisonRows($date, $selectedWarehouseId, $authorizedWarehouseIds);
    }
    ...
    protected function executeDayInventoryMatch(
        ...
        return app(DailyInventoryComparisonService::class)->executeDayInventoryMatch(
            $date,
            $productId,
            $unit,
            $warehouseId,
