(() => {
    const exportRoot = document.querySelector('[data-daily-sales-export]');
    ...
    const reportTitle = exportRoot.getAttribute('data-export-title') || 'Daily Sales Report';
    const filename = exportRoot.getAttribute('data-export-filename') || 'daily-sales-report';
