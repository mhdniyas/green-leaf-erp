...
{
    private const BUSINESS_DATE = '2026-08-01';
    ...
    public function run(): void
    {
        ...
        $missingSkus = [];
        $businessDate = Carbon::parse(self::BUSINESS_DATE)->toDateString();
        $hasDailyPriceUnit = Schema::hasColumn('daily_price_approvals', 'price_unit');

        DB::transaction(function () use ($businessDate, $hasDailyPriceUnit, &$defaultPricesUpdated, &$dailyPricesUpdated, &$missingSkus): void {
        ...
        $this->command?->info("Updated {$dailyPricesUpdated} approved daily prices for {$businessDate}.");
