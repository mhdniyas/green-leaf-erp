<section class="rounded-[2rem] border border-slate-200 bg-white p-6 shadow-sm">
    ...
    @if ($tomorrowOrder && ! $tomorrowOrder->canEditDirectly() && in_array($tomorrowOrder->state, ['submitted', 'update_requested'], true))
        <div class="mt-5 rounded-3xl border border-amber-200 bg-amber-50 p-5">
            ...
            <p class="mt-2 text-sm text-amber-800">Direct submission is closed, but you can still change quantities, add products, or remove lines and send the revised request to the Purchase Manager.</p>
