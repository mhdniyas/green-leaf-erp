@php
    ...
    $hasShopPurchasingAccess = $activeShop?->isPurchasingEnabled() ?? false;
    $purchasingChildren = [
        [
            'label' => 'History',
            'href' => route('shop-owner.purchasing.index'),
            'active' => request()->routeIs('shop-owner.purchasing.index'),
        ],
        [
            'label' => 'New Purchase',
            'href' => route('shop-owner.purchasing.create'),
            'active' => request()->routeIs('shop-owner.purchasing.create'),
        ],
        [
            'label' => 'Vendor Report',
            'href' => route('shop-owner.purchasing.reports.vendors'),
            'active' => request()->routeIs('shop-owner.purchasing.reports.*'),
        ],
        [
            'label' => 'Daily Verification',
            'href' => route('shop-owner.purchasing.verification'),
            'active' => request()->routeIs('shop-owner.purchasing.verification*'),
        ],
    ];

    if ($hasShopPurchasingAccess) {
        $shopOwnerNavItems[] = [
            'label' => 'Purchases',
            'route' => 'shop-owner.purchasing.index',
