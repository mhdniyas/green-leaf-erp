...
<script>
    ...
    const isVendorCreationAllowed = @json($shop->isVendorCreationAllowed());
    ...
    const vendorPurchasesUrl = @json(route('shop-owner.cashbook.vendor-purchases'));
    ...
    // SHARED BACKDROP & ESCAPE HANDLERS
