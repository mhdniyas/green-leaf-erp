...
<div class="mx-auto max-w-[96rem] space-y-5">
    ...
    <div class="flex flex-col gap-3 rounded-lg border border-slate-200 bg-white p-4 shadow-sm sm:flex-row sm:items-center sm:justify-between">
        ...
        <div>
            @if(($changedCount ?? 0) > 0)
                <a href="{{ route('admin.cashbook.finance.purchase.reports.purchaser-prices.whatsapp', request()->query()) }}" target="_blank" rel="noopener" class="inline-flex w-full min-h-10 items-center justify-center gap-1.5 rounded-lg bg-emerald-700 px-4 text-xs font-black text-white hover:bg-emerald-800 sm:w-auto">
