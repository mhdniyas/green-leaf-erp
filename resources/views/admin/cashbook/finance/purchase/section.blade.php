...
<div class="mx-auto max-w-[96rem] space-y-5">
    ...
    <section id="purchase-results" class="rounded-lg border border-slate-200 bg-white shadow-sm">
        <div class="hidden overflow-x-auto md:block"><table class="w-full min-w-[58rem] text-left text-xs"><thead class="bg-slate-50 text-[10px] uppercase text-slate-500">
            @if($section === 'purchasers')<tr><th class="p-3">Purchaser</th><th class="p-3 text-right">Total Purchase</th><th class="p-3 text-right">Cash</th><th class="p-3 text-right">Credit</th><th class="p-3 text-right">Funding</th><th class="p-3 text-right">Balance / Advance</th><th class="p-3 text-right">Invoices</th><th class="p-3">Action</th></tr>@endif
