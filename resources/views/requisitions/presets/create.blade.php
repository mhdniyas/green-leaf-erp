<x-layouts.app title="Create Requisition Preset">
    <div class="max-w-4xl mx-auto px-4 py-8 animate-fade-in">
        ...
        <div class="mb-8">
            ...
            <p class="text-xs text-slate-500 mt-1">Specify a preset name and add items with default quantities to create a templates list.</p>
        </div>
        ...
        <form action="{{ route('requisitions.presets.store') }}" method="POST" id="preset-form" class="space-y-6">
            @csrf
    ...
    <script>
        ...
        // Prefill with favorite products if copying staples
        @foreach($prefilledProducts ?? [] as $prod)
        ...
        // Render table on initial page load if prefilled products exist
