@php
    $purchaseManagerNavItems = [
        ['label' => 'Purchase Orders', 'route' => 'purchasing.orders.index', 'active' => request()->routeIs('purchasing.orders.*')],
        ['label' => 'Goods Receipts', 'route' => 'purchasing.grns.index', 'active' => request()->routeIs('purchasing.grns.*')],
        ['label' => 'Invoices', 'route' => 'purchasing.invoices.index', 'active' => request()->routeIs('purchasing.invoices.*')],
        ['label' => 'Suppliers', 'route' => 'purchasing.suppliers.index', 'active' => request()->routeIs('purchasing.suppliers.*')],
    ];
@endphp
...
<aside class="hidden border-r border-slate-200 bg-slate-950 text-white lg:fixed lg:inset-y-0 lg:flex lg:w-72 lg:flex-col">
    <div class="border-b border-white/10 px-6 py-6">
        ...
        <p class="mt-1 text-sm text-slate-400">Requisition review, vendor buying, receipt checks, and invoice control.</p>
    </div>
