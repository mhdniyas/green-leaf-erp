...
@section('content')
    ...
    <div class="space-y-6">
        <section class="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm">
            <form method="GET" action="{{ route('purchasing.prices.index') }}" class="grid gap-4 xl:grid-cols-[minmax(0,1fr)_180px_160px_160px_280px_auto_auto] xl:items-end">
                <div>
                ...
                <div class="flex flex-wrap items-center gap-2">
                    ...
                    <button type="button" onclick="shareOnWhatsApp()" class="inline-flex items-center justify-center gap-2 rounded-2xl bg-emerald-600 px-5 py-3 text-sm font-black text-white hover:bg-emerald-500 shadow-sm transition-all border-none cursor-pointer">
