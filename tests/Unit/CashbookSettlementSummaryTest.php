...
assert.equal(chainedResult.income, 25299.00);
assert.equal(chainedResult.expense, 18316.60);
assert.equal(chainedResult.netLabel, 'Balance');
assert.equal(chainedResult.netBalance, 6982.40);
JS;
