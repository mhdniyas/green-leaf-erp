...
use App\Http\Controllers\Web\Admin\CashbookUserAccessController;
...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('admin')->name('admin.')->group(function () {
        ...
        Route::prefix('cashbook')->name('cashbook.')->middleware('can:cashbook.access')->group(function () {
            // ── User Access Management ─────────────────────────────────────
            Route::prefix('user-access')->name('user-access.')->middleware('can:cashbook.user-access.manage')->group(function () {
                Route::get('/', [CashbookUserAccessController::class, 'index'])->name('index');
                Route::post('/{user?}', [CashbookUserAccessController::class, 'update'])->name('update');
            });
            ...
            Route::prefix('categories')->name('categories.')->group(function () {
                ...
                Route::post('/{category}/shops/{shop}/basic-header', [CashbookCategoryController::class, 'updateShopBasicHeader'])->name('shop.basic-header')->middleware('can:cashbook.settings.manage');
                Route::post('/{category}/shops/{shop}/settlement', [CashbookCategoryController::class, 'updateShopSettlement'])->name('shop.settlement')->middleware('can:cashbook.settings.manage');
                Route::post('/{category}/shops/{shop}/company-relation', [CashbookCategoryController::class, 'updateShopCompanyRelation'])->name('shop.company-relation')->middleware('can:cashbook.settings.manage');
                Route::post('/{category}/shops/{shop}/vendor-relation', [CashbookCategoryController::class, 'updateShopVendorRelation'])->name('shop.vendor-relation')->middleware('can:cashbook.settings.manage');
                Route::post('/{category}/shops/{shop}/reports', [CashbookCategoryController::class, 'updateShopReports'])->name('shop.reports')->middleware('can:cashbook.settings.manage');
                Route::post('/{category}/shops/{shop}/advanced', [CashbookCategoryController::class, 'updateShopAdvanced'])->name('shop.advanced')->middleware('can:cashbook.settings.manage');
            });

            // ── Dashboard / Landing route ──────────────────────────────────
            Route::get('/', [CashbookController::class, 'index'])->name('index')->middleware('can:cashbook.dashboard.view');

            // ── Shops Section ──────────────────────────────────────────────
            Route::get('all-shops', [CashbookController::class, 'allShops'])->name('all-shops')->middleware('can:cashbook.shops.view');
            Route::get('accept-payment', [CashbookController::class, 'acceptPaymentPage'])->name('accept-payment')->middleware('can:cashbook.shops.view');
            Route::get('income-expenses', [CashbookController::class, 'incomeExpenses'])->name('income-expenses')->middleware('can:cashbook.shops.view');
            Route::get('post-entry', [CashbookController::class, 'postEntryPage'])->name('post-entry')->middleware('can:cashbook.shops.view');
            Route::get('post-entry/{shop}', [CashbookController::class, 'postEntryPageForShop'])->name('post-entry.shop')->middleware('can:cashbook.shops.view');
            Route::get('rules-config', [CashbookController::class, 'rulesPage'])->name('rules-config')->middleware('can:cashbook.shops.view');

            Route::get('shops/{shop}', [CashbookController::class, 'salesReport'])->name('shop.show')->middleware('can:cashbook.shops.view');
            Route::get('shops/{shop}/sales-report', [CashbookController::class, 'salesReport'])->name('shop.sales-report')->middleware('can:cashbook.shops.view');
            Route::get('shops/{shop}/overview', [CashbookController::class, 'showShop'])->name('shop.overview')->middleware('can:cashbook.shops.view');
            ...
            Route::post('shops/{shop}/financial-ledger/product-entries/{productEntry}/delete', [CashbookController::class, 'deleteFinancialLedgerProductEntry'])->name('shop.financial-ledger.product-entries.delete')->middleware('can:cashbook.shops.manage');
            ...
            Route::get('shops/{shop}/cashbook-view', [CashbookController::class, 'shopCashbookLayout'])->name('shop.cashbook-view')->middleware('can:cashbook.shops.view');
            Route::post('shops/{shop}/cashbook-view/save-layout', [CashbookController::class, 'saveShopCashbookLayout'])->name('shop.cashbook-view.save-layout')->middleware('can:cashbook.shops.manage');
            Route::get('shops/{shop}/sales-report/pdf', [CashbookController::class, 'exportSalesReportPdf'])->name('shop.sales-report.pdf')->middleware('can:cashbook.shops.view');
            Route::get('shops/{shop}/sales-report/excel', [CashbookController::class, 'exportSalesReportExcel'])->name('shop.sales-report.excel')->middleware('can:cashbook.shops.view');
            Route::get('shops/{shop}/sales-report/csv', [CashbookController::class, 'exportSalesReportCsv'])->name('shop.sales-report.csv')->middleware('can:cashbook.shops.view');
            Route::post('shops/{shop}/recalculate-month', [CashbookController::class, 'recalculateMonth'])->name('shop.recalculate-month')->middleware('can:cashbook.shops.manage');
            Route::get('shops/{shop}/settlement-details', [CashbookController::class, 'showSettlementDetails'])->name('shop.settlement-details')->middleware('can:cashbook.shops.view');
            Route::get('shops/{shop}/purchases/vendors', [CashbookController::class, 'shopVendorPurchasesReport'])->name('shop.purchases.vendors')->middleware('can:cashbook.shops.view');
            Route::get('shops/{shop}/export', [CashbookController::class, 'exportShopData'])->name('shop.export')->middleware('can:cashbook.shops.view');
            Route::get('shops/{shop}/settlement', [CashbookController::class, 'redirectShopSettlement'])->name('shop.settlement')->middleware('can:cashbook.shops.view');
            Route::get('shops/{shop}/accept-payment', [CashbookController::class, 'shopSettlementPage'])->name('shop.accept-payment')->middleware('can:cashbook.shops.view');
            Route::post('shops/{shop}/accept-payment', [CashbookController::class, 'recordShopPayment'])->name('shop.accept-payment.store')->middleware('can:cashbook.shops.manage');
            Route::post('shops/{shop}/accept-payment/reconcile', [CashbookController::class, 'reconcileShopPaymentLedger'])->name('shop.accept-payment.reconcile')->middleware('can:cashbook.shops.manage');
            Route::post('shops/{shop}/receive-payment', [CashbookController::class, 'receiveShopPayment'])->name('shop.receive-payment')->middleware('can:cashbook.shops.manage');
            Route::post('shops/{shop}/allocate-payment', [CashbookController::class, 'allocateShopPayment'])->name('shop.allocate-payment')->middleware('can:cashbook.shops.manage');
            Route::post('shops/{shop}/allocate-payment/clear', [CashbookController::class, 'clearShopPaymentAllocations'])->name('shop.allocate-payment.clear')->middleware('can:cashbook.shops.manage');
            Route::delete('shops/{shop}/payments', [CashbookController::class, 'destroyShopPayment'])->name('shop.payments.destroy')->middleware('can:cashbook.shops.manage');
            Route::post('shops/{shop}/allocate-payment/clear-reallocate', [CashbookController::class, 'clearAndReallocateShopPayment'])->name('shop.allocate-payment.clear-reallocate')->middleware('can:cashbook.shops.manage');
            Route::post('shops/{shop}/allocate-payments/bulk', [CashbookController::class, 'allocateAllShopPayments'])->name('shop.allocate-payments.bulk')->middleware('can:cashbook.shops.manage');
            Route::post('shops/{shop}/allocate-payments/clear-all', [CashbookController::class, 'clearAllShopPaymentAllocationsWeb'])->name('shop.allocate-payments.clear-all')->middleware('can:cashbook.shops.manage');
            Route::post('shops/{shop}/allocations/{allocation}/remove', [CashbookController::class, 'removeShopAllocation'])->name('shop.allocations.remove')->middleware('can:cashbook.shops.manage');
            Route::post('shops/{shop}/company-payments', [CashbookController::class, 'storeCompanyPayment'])->name('shop.company-payments.store')->middleware('can:cashbook.shops.manage');
            Route::post('shops/{shop}/allocations', [CashbookController::class, 'storeCompanyExpenseAllocation'])->name('shop.allocations.store')->middleware('can:cashbook.shops.manage');
            Route::post('shops/{shop}/allocations/{allocation}/reverse', [CashbookController::class, 'reverseCompanyExpenseAllocation'])->name('shop.allocations.reverse')->middleware('can:cashbook.shops.manage');
            Route::post('shops/{shop}/petty/fund', [CashbookController::class, 'fundShopPetty'])->name('shop.petty.fund')->middleware('can:cashbook.shops.manage');
            Route::get('shops/{shop}/post-entry', [CashbookController::class, 'postEntryPageForShop'])->name('shop.post-entry')->middleware('can:cashbook.shops.view');
            Route::post('shops/{shop}/day/accept-selected', [CashbookController::class, 'acceptSelectedDayEntries'])->name('shop.day.accept-selected')->middleware('can:cashbook.shops.manage');
            Route::post('shops/{shop}/day/verify-selected', [CashbookController::class, 'verifySelectedDayEntries'])->name('shop.day.verify-selected')->middleware('can:cashbook.shops.manage');
            Route::post('shops/{shop}/day/adjustments', [CashbookController::class, 'storeDayAdjustment'])->name('shop.day.adjustments.store')->middleware('can:cashbook.shops.manage');
            Route::post('shops/{shop}/day/adjustments/reverse', [CashbookController::class, 'reverseDayAdjustment'])->name('shop.day.adjustments.reverse')->middleware('can:cashbook.shops.manage');

            Route::prefix('shops/{shop}/history')->name('shop.history.')->group(function () {
                Route::get('payments', [CashbookController::class, 'shopPaymentsHistory'])->name('payments')->middleware('can:cashbook.shops.view');
                Route::post('payments/verify-all-direct', [CashbookController::class, 'verifyAllDirectBank'])->name('payments.verify-all-direct')->middleware('can:cashbook.shops.manage');
                Route::post('payments/verify-day', [CashbookController::class, 'verifyDayPayment'])->name('payments.verify-day')->middleware('can:cashbook.shops.manage');
                Route::post('payments/allocate-day', [CashbookController::class, 'allocateDayPayment'])->name('payments.allocate-day')->middleware('can:cashbook.shops.manage');
                Route::post('payments/record-cash', [CashbookController::class, 'recordManualCashReceipt'])->name('payments.record-cash')->middleware('can:cashbook.shops.manage');
                Route::post('payments/match-payable', [CashbookController::class, 'matchReceiptToPayable'])->name('payments.match-payable')->middleware('can:cashbook.shops.manage');
                Route::get('payments/fifo-preview', [CashbookController::class, 'previewReceiptFifo'])->name('payments.fifo-preview')->middleware('can:cashbook.shops.view');
                Route::post('payments/allocate-expenses', [CashbookController::class, 'allocateReceiptExpenses'])->name('payments.allocate-expenses')->middleware('can:cashbook.shops.manage');
                Route::post('payments/undo-match', [CashbookController::class, 'undoIndividualMatch'])->name('payments.undo-match')->middleware('can:cashbook.shops.manage');
                Route::post('payments/undo-day-matches', [CashbookController::class, 'undoDayMatches'])->name('payments.undo-day-matches')->middleware('can:cashbook.shops.manage');
                Route::post('payments/undo-receipt-matches', [CashbookController::class, 'undoReceiptMatches'])->name('payments.undo-receipt-matches')->middleware('can:cashbook.shops.manage');
                Route::post('payments/undo-receipt-allocations', [CashbookController::class, 'undoReceiptAllocations'])->name('payments.undo-receipt-allocations')->middleware('can:cashbook.shops.manage');
                Route::get('allocations', [CashbookController::class, 'shopAllocationsHistory'])->name('allocations')->middleware('can:cashbook.shops.view');
                Route::get('cheques', [CashbookController::class, 'shopChequesHistory'])->name('cheques')->middleware('can:cashbook.shops.view');
                Route::get('petty', [CashbookController::class, 'shopPettyHistory'])->name('petty')->middleware('can:cashbook.shops.view');
                Route::get('adjustments', [CashbookController::class, 'shopAdjustmentsHistory'])->name('adjustments')->middleware('can:cashbook.shops.view');
                Route::get('banking', [CashbookController::class, 'shopBankingHistory'])->name('banking')->middleware('can:cashbook.shops.view');
            });

            // ── Money Flow Section ─────────────────────────────────────────
            Route::get('money-flow', [CashbookController::class, 'moneyFlow'])->name('money-flow')->middleware('can:cashbook.money-flow.view');
            Route::get('money-flow/clients/{client}', [CashbookController::class, 'moneyFlowClient'])->name('money-flow.client')->middleware('can:cashbook.money-flow.view');
            Route::get('money-flow/direct-shops', [CashbookController::class, 'moneyFlowDirectShops'])->name('money-flow.direct-shops')->middleware('can:cashbook.money-flow.view');
            Route::get('transactions/{transaction}', [CashbookController::class, 'showTransaction'])->name('transaction.show')->middleware('can:cashbook.money-flow.view');
            Route::get('transactions/{transaction}/edit', [CashbookController::class, 'editTransaction'])->name('transaction.edit')->middleware('can:cashbook.money-flow.manage');
            Route::put('transactions/{transaction}', [CashbookController::class, 'updateTransaction'])->name('transaction.update')->middleware('can:cashbook.money-flow.manage');
            Route::post('transactions/{transaction}/reverse', [CashbookController::class, 'reverseTransaction'])->name('transaction.reverse')->middleware('can:cashbook.money-flow.manage');
            Route::post('transactions/{transaction}/revert-approval', [CashbookController::class, 'revertTransactionApproval'])->name('transaction.revert-approval')->middleware('can:cashbook.money-flow.manage');
            Route::delete('transactions/{transaction}', [CashbookController::class, 'deleteTransaction'])->name('transaction.delete')->middleware('can:cashbook.money-flow.manage');
            Route::post('transactions/{transaction}/approve', [CashbookController::class, 'approveTransaction'])->name('transaction.approve')->middleware('can:cashbook.money-flow.manage');
            Route::post('transactions/{transaction}/verify', [CashbookController::class, 'verifyTransaction'])->name('transaction.verify')->middleware('can:cashbook.money-flow.manage');

            // ── Account Balance Section ────────────────────────────────────
            Route::get('account-balance', [AccountBalanceReportController::class, 'index'])->name('account-balance')->middleware('can:cashbook.account-balance.view');
            Route::delete('account-balance/statements/{entry}', [AccountBalanceReportController::class, 'destroyStatementEntry'])->name('account-balance.statements.delete')->middleware('can:cashbook.account-balance.manage');
            Route::delete('account-balance/payment-requests/{paymentRequest}', [AccountBalanceReportController::class, 'destroyPaymentRequest'])->name('account-balance.payment-requests.delete')->middleware('can:cashbook.account-balance.manage');
            Route::get('finance/journal', [CashbookController::class, 'companyFinanceJournal'])->name('finance.journal')->middleware('can:cashbook.account-balance.view');
            Route::get('finance/income-expense', [CashbookController::class, 'companyIncomeExpense'])->name('finance.income-expense')->middleware('can:cashbook.account-balance.view');
            Route::post('finance/income-expense', [CashbookController::class, 'storeCompanyIncomeExpense'])->name('finance.income-expense.store')->middleware('can:cashbook.account-balance.manage');
            Route::get('finance/income-expense/{entry:public_uuid}', [CashbookController::class, 'showCompanyIncomeExpense'])->name('finance.income-expense.show')->middleware('can:cashbook.account-balance.view');
            Route::patch('finance/income-expense/{entry:public_uuid}', [CashbookController::class, 'updateCompanyIncomeExpense'])->name('finance.income-expense.update')->middleware('can:cashbook.account-balance.manage');
            Route::delete('finance/income-expense/{entry:public_uuid}', [CashbookController::class, 'destroyCompanyIncomeExpense'])->name('finance.income-expense.destroy')->middleware('can:cashbook.account-balance.manage');
            Route::get('finance/direct-sales', [CashbookController::class, 'directCompanySales'])->name('finance.direct-sales')->middleware('can:cashbook.account-balance.view');
            Route::post('finance/direct-sales', [CashbookController::class, 'storeDirectCompanySale'])->name('finance.direct-sales.store')->middleware('can:cashbook.account-balance.manage');
            Route::get('finance/direct-sales/{directCompanySale:public_uuid}', [CashbookController::class, 'showDirectCompanySale'])->name('finance.direct-sales.show')->middleware('can:cashbook.account-balance.view');
            Route::get('finance/direct-sales/{directCompanySale:public_uuid}/bill', [CashbookController::class, 'directCompanySaleBill'])->name('finance.direct-sales.bill')->middleware('can:cashbook.account-balance.view');
            Route::get('finance/journal-entry/{journalEntry}', [CashbookController::class, 'companyFinanceJournalEntryShow'])->name('finance.journal.entry-show')->middleware('can:cashbook.account-balance.view');
            Route::post('finance/journal-entry/{journalEntry}', [CashbookController::class, 'companyFinanceJournalEntryUpdate'])->name('finance.journal.entry-update')->middleware('can:cashbook.account-balance.manage');
            Route::put('finance/journal-entry/{journalEntry}', [CashbookController::class, 'companyFinanceJournalEntryUpdate'])->middleware('can:cashbook.account-balance.manage');
            Route::get('finance/journal-ref/{paymentRef}', [CashbookController::class, 'companyFinanceJournalShowSecure'])->name('finance.journal.secure-show')->middleware('can:cashbook.account-balance.view');
            Route::get('finance/journal/{paymentRequest}', [CashbookController::class, 'companyFinanceJournalShow'])->name('finance.journal.show')->middleware('can:cashbook.account-balance.view');

            // ── Reconciliation Section ─────────────────────────────────────
            Route::get('finance', [CashbookController::class, 'companyFinancePage'])->name('finance')->middleware('can:cashbook.reconciliation.view');
            Route::get('finance/cheque-submission', [CashbookController::class, 'companyFinanceChequeSubmission'])->name('finance.cheque-submission')->middleware('can:cashbook.reconciliation.view');
            Route::post('finance/reconciliation/statements/{statement:public_uuid}/company-accounting', [CashbookController::class, 'classifyCompanyAccountingStatement'])->whereUuid('statement')->name('finance.reconciliation.classify-company-accounting')->middleware('can:cashbook.reconciliation.manage');
            Route::post('finance/reconciliation/statements/{statement:public_uuid}/shop-petty', [CashbookController::class, 'classifyShopPettyStatement'])->whereUuid('statement')->name('finance.reconciliation.classify-shop-petty')->middleware('can:cashbook.reconciliation.manage');
            Route::post('finance/reconciliation/statements/{statement:public_uuid}/company-payable', [CashbookController::class, 'classifyCompanyPayableStatement'])->whereUuid('statement')->name('finance.reconciliation.classify-company-payable')->middleware('can:cashbook.reconciliation.manage');
            Route::post('finance/reconciliation/statements/{statement:public_uuid}/vendor-payment', [CashbookController::class, 'classifyVendorPaymentStatement'])->whereUuid('statement')->name('finance.reconciliation.classify-vendor-payment')->middleware('can:cashbook.reconciliation.manage');
            Route::post('finance/reconciliation/statements/{statement:public_uuid}/purchaser-funding', [CashbookController::class, 'classifyPurchaserFundingStatement'])->whereUuid('statement')->name('finance.reconciliation.classify-purchaser-funding')->middleware('can:cashbook.reconciliation.manage');
            Route::post('finance/reconciliation/statements/{statement:public_uuid}/shop-payment', [CashbookController::class, 'classifyShopPaymentStatement'])->whereUuid('statement')->name('finance.reconciliation.classify-shop-payment')->middleware('can:cashbook.reconciliation.manage');
            Route::post('finance/reconciliation/statements/{statement:public_uuid}/verify-shop-collection', [CashbookController::class, 'verifyShopCollectionStatement'])->whereUuid('statement')->name('finance.reconciliation.verify-shop-collection')->middleware('can:cashbook.reconciliation.manage');
            Route::post('finance/reconciliation/statements/{statement:public_uuid}/match-existing', [CashbookController::class, 'matchExistingStatement'])->whereUuid('statement')->name('finance.reconciliation.match-existing')->middleware('can:cashbook.reconciliation.manage');
            Route::post('finance/reconciliation/statements/{statement:public_uuid}/confirm-suggestion', [CashbookController::class, 'confirmSuggestedStatement'])->whereUuid('statement')->name('finance.reconciliation.confirm-suggestion')->middleware('can:cashbook.reconciliation.manage');
            Route::post('finance/reconciliation/confirm-suggestions', [CashbookController::class, 'confirmSuggestedStatements'])->name('finance.reconciliation.confirm-suggestions')->middleware('can:cashbook.reconciliation.manage');
            Route::post('finance/reconciliation/auto-match-shop-collections/preview', [CashbookController::class, 'previewAutoMatchShopCollections'])->name('finance.reconciliation.auto-match-shop-collections.preview')->middleware('can:cashbook.reconciliation.manage');
            Route::post('finance/reconciliation/auto-match-shop-collections/execute', [CashbookController::class, 'executeAutoMatchShopCollections'])->name('finance.reconciliation.auto-match-shop-collections.execute')->middleware('can:cashbook.reconciliation.manage');
            Route::post('finance/reconciliation/auto-match-shop-collections/reassign-bank-mapping', [CashbookController::class, 'reassignAutoMatchBankMapping'])->name('finance.reconciliation.auto-match-shop-collections.reassign')->middleware('can:cashbook.reconciliation.manage');
            Route::post('finance/reconciliation/statements/{statement:public_uuid}/salary-payment', [CashbookController::class, 'classifySalaryPaymentStatement'])->whereUuid('statement')->name('finance.reconciliation.classify-salary-payment')->middleware('can:cashbook.reconciliation.manage');
            Route::post('finance/reconciliation/statements/{statement:public_uuid}/salary-advance', [CashbookController::class, 'classifySalaryAdvanceStatement'])->whereUuid('statement')->name('finance.reconciliation.classify-salary-advance')->middleware('can:cashbook.reconciliation.manage');
            Route::get('finance/reconciliation/statements/{statement:public_uuid}/create', [CashbookController::class, 'createCompanyFinanceReconciliationTransaction'])->whereUuid('statement')->name('finance.reconciliation.create-transaction')->middleware('can:cashbook.reconciliation.manage');
            Route::post('finance/reconciliation/reset-month', [CashbookController::class, 'resetMonthReconciliation'])->name('finance.reconciliation.reset-month')->middleware('can:cashbook.reconciliation.manage');
            Route::get('finance/reconciliation/pending-candidates', [CashbookController::class, 'pendingReconciliationCandidates'])->name('finance.reconciliation.pending-candidates')->middleware('can:cashbook.reconciliation.view');
            Route::get('finance/reconciliation/{statementRef?}', [CashbookController::class, 'companyFinanceReconciliation'])->name('finance.reconciliation')->middleware('can:cashbook.reconciliation.view');
            Route::post('finance/reconciliation/{statementRef}/match', [CashbookController::class, 'matchStatementReconciliation'])->name('finance.reconciliation.match')->middleware('can:cashbook.reconciliation.manage');
            Route::post('finance/reconciliation/{statementRef}/match-journal', [CashbookController::class, 'matchStatementJournalReconciliation'])->name('finance.reconciliation.match-journal')->middleware('can:cashbook.reconciliation.manage');
            Route::get('finance/purchasers', [CashbookController::class, 'companyFinancePurchasers'])->name('finance.purchasers')->middleware('can:cashbook.reconciliation.view');
            Route::get('finance/purchasers/{purchaser:public_uuid}/details', [CashbookController::class, 'companyFinancePurchaserDetails'])->name('finance.purchasers.details')->middleware('can:cashbook.reconciliation.view');
            Route::post('finance/purchasers/{purchaser:public_uuid}/funding', [CashbookController::class, 'storePurchaserFunding'])->name('finance.purchasers.funding.store')->middleware('can:cashbook.reconciliation.manage');
            Route::post('finance/purchasers/{purchaser:public_uuid}/funding/{credit}/update', [CashbookController::class, 'updatePurchaserFunding'])->name('finance.purchasers.funding.update')->middleware('can:cashbook.reconciliation.manage');
            Route::post('finance/purchasers/{purchaser:public_uuid}/funding/{credit}/delete', [CashbookController::class, 'deletePurchaserFunding'])->name('finance.purchasers.funding.delete')->middleware('can:cashbook.reconciliation.manage');
            Route::delete('finance/purchasers/{purchaser:public_uuid}/funding/{credit}', [CashbookController::class, 'deletePurchaserFunding'])->middleware('can:cashbook.reconciliation.manage');
            Route::get('finance/purchasers/{purchaser:public_uuid}/funding/{credit}/candidates', [CashbookController::class, 'purchaserFundingCandidates'])->name('finance.purchasers.funding.candidates')->middleware('can:cashbook.reconciliation.view');
            Route::post('finance/purchasers/{purchaser:public_uuid}/funding/{credit}/match-statement', [CashbookController::class, 'matchStatementPurchaserFunding'])->name('finance.purchasers.funding.match-statement')->middleware('can:cashbook.reconciliation.manage');
            Route::post('finance/purchasers/{purchaser:public_uuid}/funding/{credit}/replace-match', [CashbookController::class, 'replaceMatchPurchaserFunding'])->name('finance.purchasers.funding.replace-match')->middleware('can:cashbook.reconciliation.manage');
            Route::post('finance/purchasers/{purchaser:public_uuid}/funding/{credit}/match-manual', [CashbookController::class, 'matchManualPurchaserFunding'])->name('finance.purchasers.funding.match-manual')->middleware('can:cashbook.reconciliation.manage');
            Route::get('finance/purchasers/{purchaser:public_uuid}/funding/{credit}/trace', [CashbookController::class, 'tracePurchaserFunding'])->name('finance.purchasers.funding.trace')->middleware('can:cashbook.reconciliation.view');
            Route::post('finance/purchasers/{purchaser:public_uuid}/funding/{credit}/unmatch', [CashbookController::class, 'unmatchPurchaserFunding'])->name('finance.purchasers.funding.unmatch')->middleware('can:cashbook.reconciliation.manage');
            Route::post('finance/purchasers/{purchaser:public_uuid}/funding/{credit}/correct', [CashbookController::class, 'correctPurchaserFunding'])->name('finance.purchasers.funding.correct')->middleware('can:cashbook.reconciliation.manage');
            Route::get('finance/purchasers/{purchaser:public_uuid}/funding/{credit}/reversal-preview', [CashbookController::class, 'fundingReversalPreview'])->name('finance.purchasers.funding.reversal-preview')->middleware('can:cashbook.reconciliation.view');

            // Direct aliases under /finance/purchase/purchasers/
            Route::post('finance/purchase/purchasers/{purchaser:public_uuid}/funding/{credit}/update', [CashbookController::class, 'updatePurchaserFunding'])->middleware('can:cashbook.reconciliation.manage');
            Route::post('finance/purchase/purchasers/{purchaser:public_uuid}/funding/{credit}/delete', [CashbookController::class, 'deletePurchaserFunding'])->middleware('can:cashbook.reconciliation.manage');
            Route::delete('finance/purchase/purchasers/{purchaser:public_uuid}/funding/{credit}', [CashbookController::class, 'deletePurchaserFunding'])->middleware('can:cashbook.reconciliation.manage');
            Route::get('finance/purchase/purchasers/{purchaser:public_uuid}/funding/{credit}/reversal-preview', [CashbookController::class, 'fundingReversalPreview'])->middleware('can:cashbook.reconciliation.view');
            Route::get('finance/purchase/purchasers/{purchaser:public_uuid}/funding/{credit}/candidates', [CashbookController::class, 'purchaserFundingCandidates'])->middleware('can:cashbook.reconciliation.view');
            Route::post('finance/purchase/purchasers/{purchaser:public_uuid}/funding/{credit}/match-statement', [CashbookController::class, 'matchStatementPurchaserFunding'])->middleware('can:cashbook.reconciliation.manage');
            Route::post('finance/purchase/purchasers/{purchaser:public_uuid}/funding/{credit}/replace-match', [CashbookController::class, 'replaceMatchPurchaserFunding'])->middleware('can:cashbook.reconciliation.manage');
            Route::post('finance/purchase/purchasers/{purchaser:public_uuid}/funding/{credit}/match-manual', [CashbookController::class, 'matchManualPurchaserFunding'])->middleware('can:cashbook.reconciliation.manage');
            Route::get('finance/purchase/purchasers/{purchaser:public_uuid}/funding/{credit}/trace', [CashbookController::class, 'tracePurchaserFunding'])->middleware('can:cashbook.reconciliation.view');
            Route::post('finance/purchase/purchasers/{purchaser:public_uuid}/funding/{credit}/unmatch', [CashbookController::class, 'unmatchPurchaserFunding'])->middleware('can:cashbook.reconciliation.manage');
            Route::post('finance/purchase/purchasers/{purchaser:public_uuid}/funding/{credit}/correct', [CashbookController::class, 'correctPurchaserFunding'])->middleware('can:cashbook.reconciliation.manage');

            Route::get('finance/vendor-credit', [CashbookController::class, 'companyFinanceVendorCredit'])->name('finance.vendor-credit')->middleware('can:cashbook.reconciliation.view');
            Route::get('finance/vendor-credit/settlements', [CashbookController::class, 'companyFinanceVendorSettlementHistory'])->name('finance.vendor-credit.settlements')->middleware('can:cashbook.reconciliation.view');
            Route::get('finance/vendor-credit/settlements/{vendorSettlement:public_uuid}', [CashbookController::class, 'companyFinanceVendorSettlementDetails'])->whereUuid('vendorSettlement')->name('finance.vendor-credit.settlements.show')->middleware('can:cashbook.reconciliation.view');
            Route::post('finance/vendor-credit/settlements/{vendorSettlement:public_uuid}/reconcile', [CashbookController::class, 'reconcileVendorSettlement'])->whereUuid('vendorSettlement')->name('finance.vendor-credit.settlements.reconcile')->middleware('can:cashbook.reconciliation.manage');
            Route::post('finance/vendor-credit/settlements/{vendorSettlement:public_uuid}/update', [CashbookController::class, 'updateVendorSettlement'])->whereUuid('vendorSettlement')->name('finance.vendor-credit.settlements.update')->middleware('can:cashbook.reconciliation.manage');
            Route::post('finance/vendor-credit/settlements/{vendorSettlement:public_uuid}/delete', [CashbookController::class, 'deleteVendorSettlement'])->whereUuid('vendorSettlement')->name('finance.vendor-credit.settlements.delete')->middleware('can:cashbook.reconciliation.manage');
            Route::get('finance/vendor-credit/settlements/{vendorSettlement:public_uuid}/reversal-preview', [CashbookController::class, 'vendorSettlementReversalPreview'])->whereUuid('vendorSettlement')->name('finance.vendor-credit.settlements.reversal-preview')->middleware('can:cashbook.reconciliation.view');
            Route::get('finance/vendor-credit/{supplier:public_uuid}', [CashbookController::class, 'companyFinanceVendorCreditShow'])->whereUuid('supplier')->name('finance.vendor-credit.show')->middleware('can:cashbook.reconciliation.view');
            Route::post('finance/vendor-credit/{invoice:public_uuid}/pay', [CashbookController::class, 'settleVendorCreditInvoice'])->whereUuid('invoice')->name('finance.vendor-credit.pay')->middleware('can:cashbook.reconciliation.manage');
            Route::post('finance/vendor-credit/{supplier:public_uuid}/settle', [CashbookController::class, 'settleVendorCredit'])->whereUuid('supplier')->name('finance.vendor-credit.settle')->middleware('can:cashbook.reconciliation.manage');
            Route::post('finance/statement-entries', [CashbookController::class, 'storeCompanyStatementEntry'])->name('finance.statement-entries.store')->middleware('can:cashbook.reconciliation.manage');
            Route::post('finance/payments/{paymentRequest}/reconcile', [CashbookController::class, 'reconcileCompanyPayment'])->name('finance.payments.reconcile')->middleware('can:cashbook.reconciliation.manage');

            Route::get('finance/purchase', [CashbookController::class, 'companyFinancePurchaseDashboard'])->name('finance.purchase')->middleware('can:cashbook.reconciliation.view');
            Route::get('finance/purchase/monthly-summary', [PurchaserMonthlySummaryController::class, 'index'])->name('finance.purchase.monthly-summary.index')->middleware('can:cashbook.reconciliation.view');
            Route::get('finance/purchase/monthly-summary/{purchaser:public_uuid}', [PurchaserMonthlySummaryController::class, 'show'])->name('finance.purchase.monthly-summary.show')->middleware('can:cashbook.reconciliation.view');
            Route::get('finance/purchase/purchasers', [CashbookController::class, 'companyFinancePurchaseSection'])->defaults('section', 'purchasers')->name('finance.purchase.purchasers')->middleware('can:cashbook.reconciliation.view');
            Route::get('finance/purchase/purchasers/{purchaser:public_uuid}', [CashbookController::class, 'companyFinancePurchasePurchaser'])->name('finance.purchase.purchasers.show')->middleware('can:cashbook.reconciliation.view');
            Route::get('finance/purchase/purchasers/{purchaser:public_uuid}/vendors/{supplier:public_uuid}', [CashbookController::class, 'companyFinancePurchasePurchaserVendorDetail'])->withoutScopedBindings()->name('finance.purchase.purchasers.vendors.show')->middleware('can:cashbook.reconciliation.view');
            Route::get('finance/purchase/vendors', [CashbookController::class, 'companyFinancePurchaseSection'])->defaults('section', 'vendors')->name('finance.purchase.vendors')->middleware('can:cashbook.reconciliation.view');
            Route::get('finance/purchase/vendors/{supplier:public_uuid}', [CashbookController::class, 'companyFinancePurchaseVendor'])->name('finance.purchase.vendors.show')->middleware('can:cashbook.reconciliation.view');
            Route::get('finance/purchase/categories', [CashbookController::class, 'companyFinancePurchaseSection'])->defaults('section', 'categories')->name('finance.purchase.categories')->middleware('can:cashbook.reconciliation.view');
            Route::get('finance/purchase/categories/{category}', [CashbookController::class, 'companyFinancePurchaseCategory'])->name('finance.purchase.categories.show')->middleware('can:cashbook.reconciliation.view');
            Route::get('finance/purchase/invoices', [CashbookController::class, 'companyFinancePurchaseSection'])->defaults('section', 'invoices')->name('finance.purchase.invoices')->middleware('can:cashbook.reconciliation.view');
            Route::get('finance/purchase/reports', [CashbookController::class, 'companyFinancePurchaseReports'])->name('finance.purchase.reports')->middleware('can:cashbook.reconciliation.view');
            Route::get('finance/purchase/purchaser-expenses', [CashbookController::class, 'companyFinancePurchaserExpenseReport'])->name('finance.purchase.purchaser-expenses')->middleware('can:cashbook.reconciliation.view');
            Route::get('finance/purchase/purchaser-expenses/export/pdf', [CashbookController::class, 'companyFinancePurchaserExpenseReportPdf'])->name('finance.purchase.purchaser-expenses.export.pdf')->middleware('can:cashbook.reconciliation.view');
            Route::get('finance/purchase/purchaser-expenses/export/csv', [CashbookController::class, 'companyFinancePurchaserExpenseReportCsv'])->name('finance.purchase.purchaser-expenses.export.csv')->middleware('can:cashbook.reconciliation.view');
            Route::get('finance/purchase/purchaser-expenses/export/excel', [CashbookController::class, 'companyFinancePurchaserExpenseReportExcel'])->name('finance.purchase.purchaser-expenses.export.excel')->middleware('can:cashbook.reconciliation.view');
            Route::get('finance/purchase/reports/daily', [CashbookController::class, 'companyFinancePurchaseDailyReport'])->name('finance.purchase.reports.daily')->middleware('can:cashbook.reconciliation.view');
            Route::get('finance/purchase/reports/credit-purchases', [CashbookController::class, 'companyFinancePurchaseCreditReport'])->name('finance.purchase.reports.credit-purchases')->middleware('can:cashbook.reconciliation.view');
            Route::get('finance/purchase/reports/purchasers', [CashbookController::class, 'companyFinancePurchasePurchaserReport'])->name('finance.purchase.reports.purchasers')->middleware('can:cashbook.reconciliation.view');
            Route::get('finance/purchase/reports/prices', [CashbookController::class, 'companyFinancePurchasePriceReport'])->name('finance.purchase.reports.prices')->middleware('can:cashbook.reconciliation.view');
            Route::get('finance/purchase/reports/prices/export/pdf', [CashbookController::class, 'companyFinancePurchasePriceReportPdf'])->name('finance.purchase.reports.prices.export.pdf')->middleware('can:cashbook.reconciliation.view');
            Route::get('finance/purchase/reports/prices/{product}', [CashbookController::class, 'companyFinancePurchasePriceProduct'])->name('finance.purchase.reports.prices.product')->middleware('can:cashbook.reconciliation.view');
            Route::get('finance/purchase/reports/changed-items', [CashbookController::class, 'companyFinancePurchaseChangedItems'])->name('finance.purchase.reports.changed-items')->middleware('can:cashbook.reconciliation.view');
            Route::get('finance/purchase/reports/changed-items/whatsapp', [CashbookController::class, 'companyFinancePurchaseChangedItemsWhatsApp'])->name('finance.purchase.reports.changed-items.whatsapp')->middleware('can:cashbook.reconciliation.view');
            Route::get('finance/purchase/reports/purchaser-prices', [CashbookController::class, 'companyFinancePurchaserPriceReport'])->name('finance.purchase.reports.purchaser-prices')->middleware('can:cashbook.reconciliation.view');
            Route::get('finance/purchase/reports/purchaser-prices/whatsapp', [CashbookController::class, 'companyFinancePurchaserPriceWhatsApp'])->name('finance.purchase.reports.purchaser-prices.whatsapp')->middleware('can:cashbook.reconciliation.view');
            Route::get('finance/purchase/report', [CashbookController::class, 'companyFinancePurchaseReport'])->name('finance.purchase.report')->middleware('can:cashbook.reconciliation.view');

            Route::get('bank-accounts/create', [CashbookController::class, 'createBankAccountPage'])->name('bank-accounts.create')->middleware('can:cashbook.reconciliation.manage');
            Route::post('bank-accounts', [CashbookController::class, 'storeBankAccount'])->name('bank-accounts.store')->middleware('can:cashbook.reconciliation.manage');
            Route::get('bank-accounts/{account}', [CashbookController::class, 'showBankAccount'])->name('bank-accounts.show')->middleware('can:cashbook.reconciliation.view');
            Route::get('bank-accounts/{account}/statement', [CashbookController::class, 'showBankAccountStatement'])->name('bank-accounts.statement')->middleware('can:cashbook.reconciliation.view');
            Route::post('bank-accounts/{account}/statement/import', [CashbookController::class, 'importBankAccountStatement'])->name('bank-accounts.statement.import')->middleware('can:cashbook.reconciliation.manage');
            Route::post('bank-accounts/{account}/statement/{statementRef}/verify', [CashbookController::class, 'verifyPendingStatement'])->name('bank-accounts.statement.verify')->middleware('can:cashbook.reconciliation.manage');
            Route::patch('bank-accounts/{account}/statement/duplicates/{statementRef}/clear', [CashbookController::class, 'clearStatementDuplicateFlag'])->name('bank-accounts.statement.duplicates.clear')->middleware('can:cashbook.reconciliation.manage');
            Route::put('bank-accounts/{account}', [CashbookController::class, 'updateBankAccount'])->name('bank-accounts.update')->middleware('can:cashbook.reconciliation.manage');
            Route::delete('bank-accounts/{account}', [CashbookController::class, 'deleteBankAccount'])->name('bank-accounts.delete')->middleware('can:cashbook.reconciliation.manage');

            // ── Inventory Section ──────────────────────────────────────────
            Route::prefix('assets/trays')->name('assets.trays.')->group(function () {
                Route::get('/', [AdminTrayAssetController::class, 'index'])->name('index')->middleware('can:cashbook.inventory.view');
                Route::post('/', [AdminTrayAssetController::class, 'store'])->name('store')->middleware('can:cashbook.inventory.manage');
                Route::get('/{trayType}', [AdminTrayAssetController::class, 'show'])->name('show')->middleware('can:cashbook.inventory.view');
                Route::get('/{trayType}/edit', [AdminTrayAssetController::class, 'edit'])->name('edit')->middleware('can:cashbook.inventory.manage');
                Route::put('/{trayType}', [AdminTrayAssetController::class, 'update'])->name('update')->middleware('can:cashbook.inventory.manage');
                Route::get('/shop/{shop}/date/{date}/edit', [AdminTrayAssetController::class, 'editShopDate'])->name('shop-date.edit')->middleware('can:cashbook.inventory.manage');
                Route::put('/shop/{shop}/date/{date}', [AdminTrayAssetController::class, 'updateShopDate'])->name('shop-date.update')->middleware('can:cashbook.inventory.manage');
            });

            Route::prefix('purchaser-business-days')->name('purchaser-business-days.')->group(function () {
                Route::get('/', [AdminPurchaserBusinessDayController::class, 'index'])->name('index')->middleware('can:cashbook.inventory.view');
                Route::get('reports', [AdminPurchaserBusinessDayController::class, 'reports'])->name('reports')->middleware('can:cashbook.inventory.view');
                Route::get('reports/pending-export/pdf', [AdminPurchaserBusinessDayController::class, 'exportPendingPdf'])->name('reports.pending-pdf')->middleware('can:cashbook.inventory.view');
                Route::post('allotments/preview', [AdminPurchaserBusinessDayController::class, 'previewAllotment'])->name('allotments.preview')->middleware('can:cashbook.inventory.manage');
                Route::post('allotments/assign', [AdminPurchaserBusinessDayController::class, 'assignAllotment'])->name('allotments.assign')->middleware('can:cashbook.inventory.manage');
                Route::get('allotments/{product}/history', [AdminPurchaserBusinessDayController::class, 'productHistory'])->name('allotments.history')->middleware('can:cashbook.inventory.view');
                Route::get('{uuid}', [AdminPurchaserBusinessDayController::class, 'show'])->name('show')->middleware('can:cashbook.inventory.view');
                Route::post('{uuid}/reopen', [AdminPurchaserBusinessDayController::class, 'reopen'])->name('reopen')->middleware('can:cashbook.inventory.manage');
            });

            Route::get('auto-match', [AdminDailyAutoMatchController::class, 'index'])->name('auto-match')->middleware('can:cashbook.inventory.view');
            Route::get('auto-match/preview', [AdminDailyAutoMatchController::class, 'preview'])->name('auto-match.preview')->middleware('can:cashbook.inventory.view');
            Route::post('auto-match/execute', [AdminDailyAutoMatchController::class, 'execute'])->name('auto-match.execute')->middleware('can:cashbook.inventory.manage');
            Route::get('inventory', [AdminCashbookReportsController::class, 'inventory'])->name('inventory')->middleware('can:cashbook.inventory.view');
            Route::get('inventory/print-pending', [AdminCashbookReportsController::class, 'printPendingBills'])->name('inventory.print-pending')->middleware('can:cashbook.inventory.view');
            Route::get('inventory/print-unmatched', [AdminCashbookReportsController::class, 'printUnmatchedInventory'])->name('inventory.print-unmatched')->middleware('can:cashbook.inventory.view');
            Route::get('inventory/share/unmatched-advances/whatsapp', [AdminCashbookReportsController::class, 'shareUnmatchedAdvancesWhatsApp'])->name('inventory.share.unmatched-advances.whatsapp')->middleware('can:cashbook.inventory.view');
            Route::get('inventory/pending-bills-days', [AdminCashbookReportsController::class, 'pendingBillsDaysSummary'])->name('inventory.pending-bills-days')->middleware('can:cashbook.inventory.view');
            Route::get('inventory/pending-bills-day-details', [AdminCashbookReportsController::class, 'pendingBillsDayDetails'])->name('inventory.pending-bills-day-details')->middleware('can:cashbook.inventory.view');
            Route::post('inventory/accept-pending-bills', [AdminCashbookReportsController::class, 'acceptPendingBills'])->name('inventory.accept-pending-bills')->middleware('can:cashbook.inventory.manage');
            Route::post('inventory/match-bill/{goodsReceived}', [AdminCashbookReportsController::class, 'matchBill'])->name('inventory.match-bill')->middleware('can:cashbook.inventory.manage');
            Route::get('inventory/auto-clear-plan', [AdminCashbookReportsController::class, 'autoClearPlan'])->name('inventory.auto-clear-plan')->middleware('can:cashbook.inventory.view');
            Route::post('inventory/auto-clear-execute', [AdminCashbookReportsController::class, 'autoClearExecute'])->name('inventory.auto-clear-execute')->middleware('can:cashbook.inventory.manage');
            Route::get('inventory/manual-match-suggestions/{order}', [AdminCashbookReportsController::class, 'manualMatchSuggestions'])->name('inventory.manual-match-suggestions')->middleware('can:cashbook.inventory.view');
            Route::post('inventory/manual-match/{order}', [AdminCashbookReportsController::class, 'manualMatchExecute'])->name('inventory.manual-match')->middleware('can:cashbook.inventory.manage');
            Route::post('inventory/resolve-unit-difference', [AdminCashbookReportsController::class, 'resolveUnitDifference'])->name('inventory.resolve-unit-difference')->middleware('can:cashbook.inventory.manage');
            Route::post('inventory/fix-advance-units', [AdminCashbookReportsController::class, 'fixAdvanceUnits'])->name('inventory.fix-advance-units')->middleware('can:cashbook.inventory.manage');
            Route::post('inventory/update-item-unit', [AdminCashbookReportsController::class, 'updateItemUnit'])->name('inventory.update-item-unit')->middleware('can:cashbook.inventory.manage');
            Route::post('inventory/match-day', [AdminCashbookReportsController::class, 'matchDayInventory'])->name('inventory.match-day')->middleware('can:cashbook.inventory.manage');
            Route::post('inventory/match-all-day', [AdminCashbookReportsController::class, 'matchAllDayInventory'])->name('inventory.match-all-day')->middleware('can:cashbook.inventory.manage');
            Route::post('inventory/receive-all-pending-bills', [AdminCashbookReportsController::class, 'receiveAllPendingBills'])->name('inventory.receive-all-pending-bills')->middleware('can:cashbook.inventory.manage');
            Route::post('inventory/receive-single-bill', [AdminCashbookReportsController::class, 'receiveSingleBill'])->name('inventory.receive-single-bill')->middleware('can:cashbook.inventory.manage');
            Route::post('inventory/move-to-damage', [AdminCashbookReportsController::class, 'moveToDamage'])->name('inventory.move-to-damage')->middleware('can:cashbook.inventory.manage');
            Route::post('inventory/clear-advances', [AdminCashbookReportsController::class, 'clearAdvances'])->name('inventory.clear-advances')->middleware('can:cashbook.inventory.manage');
            Route::get('bill-changes', [AdminCashbookReportsController::class, 'billChanges'])->name('bill-changes')->middleware('can:cashbook.inventory.view');
            Route::get('bill-changes/api/shop-day', [AdminCashbookReportsController::class, 'billChangesShopDay'])->name('bill-changes.shop-day')->middleware('can:cashbook.inventory.view');
            Route::get('reports/products', [AdminCashbookReportsController::class, 'products'])->name('reports.products')->middleware('can:cashbook.inventory.view');
            Route::get('products', [AdminCashbookReportsController::class, 'products'])->name('products')->middleware('can:cashbook.inventory.view');

            // ── Reports Section ────────────────────────────────────────────
            Route::get('monthly-closing-summary', [MonthlyClosingSummaryController::class, 'index'])->name('monthly-closing-summary.index')->middleware('can:cashbook.reports.view');
            Route::get('monthly-closing-summary/shop/{shop}', [MonthlyClosingSummaryController::class, 'show'])->name('monthly-closing-summary.show')->middleware('can:cashbook.reports.view');
            Route::get('overview-cards', [AdminCashbookReportsController::class, 'hub'])->name('reports.hub')->middleware('can:cashbook.reports.view');
            Route::get('reports', [CashbookController::class, 'reports'])->name('reports')->middleware('can:cashbook.reports.view');
            Route::get('reports/shop/{shop}', [AdminCashbookReportsController::class, 'detail'])->name('reports.shop')->middleware('can:cashbook.reports.view');
            Route::get('reports/charts', [AdminCashbookReportsController::class, 'charts'])->name('reports.charts')->middleware('can:cashbook.reports.view');
            Route::get('reports/analytics', [AdminCashbookReportsController::class, 'analytics'])->name('reports.analytics')->middleware('can:cashbook.reports.view');
            Route::get('reports/gl-bills', [AdminCashbookReportsController::class, 'glBills'])->name('reports.gl-bills')->middleware('can:cashbook.reports.view');
            Route::get('reports/gl-bills/export/csv', [AdminCashbookReportsController::class, 'glBillsExportCsv'])->name('reports.gl-bills.export.csv')->middleware('can:cashbook.reports.view');
            Route::get('reports/gl-bills/export/pdf', [AdminCashbookReportsController::class, 'glBillsExportPdf'])->name('reports.gl-bills.export.pdf')->middleware('can:cashbook.reports.view');
            Route::get('warehouse-sales', [AdminCashbookReportsController::class, 'warehouseSales'])->name('warehouse-sales')->middleware('can:cashbook.reports.view');
            Route::get('finance/gl-bills', [AdminCashbookReportsController::class, 'glBills'])->name('finance.gl-bills')->middleware('can:cashbook.reports.view');
            Route::get('reports/api/hub', [AdminCashbookReportsController::class, 'apiHubData'])->name('reports.api.hub')->middleware('can:cashbook.reports.view');
            Route::get('mobile/ledger/{shop}', [AdminCashbookReportsController::class, 'mobileLedger'])->name('reports.mobile-ledger')->middleware('can:cashbook.reports.view');
            Route::get('reports/export/csv', [CashbookController::class, 'exportReportsCsv'])->name('reports.export.csv')->middleware('can:cashbook.reports.view');
            Route::get('reports/export/excel', [CashbookController::class, 'exportReportsExcel'])->name('reports.export.excel')->middleware('can:cashbook.reports.view');
            Route::get('reports/export/pdf', [CashbookController::class, 'exportReportsPdf'])->name('reports.export.pdf')->middleware('can:cashbook.reports.view');
            Route::get('reports/expense-audit', [CashbookController::class, 'expenseAuditReport'])->name('reports.expense-audit')->middleware('can:cashbook.reports.view');

            // ── Green Leaf Monthly Reports ────────────────────────────────────
            Route::prefix('reports/monthly')->name('monthly-report.')->middleware('can:cashbook.reports.view')->group(function () {
            ...
            Route::prefix('settings/final-report')->name('settings.final-report.')->group(function () {
                Route::get('/', [FinalReportSettingsController::class, 'index'])->name('index')->middleware('can:cashbook.settings.view');
                Route::match(['POST', 'PUT'], '/shop-headings', [FinalReportSettingsController::class, 'updateShopHeadings'])->name('shop-headings')->middleware('can:cashbook.settings.manage');
                Route::match(['POST', 'PUT'], '/product-groups', [FinalReportSettingsController::class, 'updateProductGroups'])->name('product-groups')->middleware('can:cashbook.settings.manage');
                Route::match(['POST', 'PUT'], '/expense-mappings', [FinalReportSettingsController::class, 'updateExpenseMappings'])->name('expense-mappings')->middleware('can:cashbook.settings.manage');
                Route::get('/readiness', [FinalReportSettingsController::class, 'readiness'])->name('readiness')->middleware('can:cashbook.settings.view');
            });

            Route::get('settings', [CashbookController::class, 'settingsPage'])->name('settings')->middleware('can:cashbook.settings.view');
            Route::post('settings/staff', [CashbookController::class, 'updateStaffSettings'])->name('settings.staff')->middleware('can:cashbook.settings.manage');
            Route::post('settings/vendor-purchase-edit-window', [CashbookController::class, 'updateVendorPurchaseEditWindow'])->name('settings.vendor-purchase-edit-window')->middleware('can:cashbook.settings.manage');
            Route::get('settings/shops/{shop}', [CashbookController::class, 'shopSettingsPage'])->name('settings.shop')->middleware('can:cashbook.settings.view');
            Route::post('settings/shops/{shop}/toggle-purchasing', [CashbookController::class, 'toggleShopPurchasing'])->name('settings.shop.toggle-purchasing')->middleware('can:cashbook.settings.manage');
            ...
            Route::get('settings/shops/{shop}/settlements', [CashbookSettlementController::class, 'index'])->name('settings.shop.settlements.index')->middleware('can:cashbook.settings.view');
            Route::post('settings/shops/{shop}/settlements/reorder', [CashbookSettlementController::class, 'reorder'])->name('settings.shop.settlements.reorder')->middleware('can:cashbook.settings.manage');
            Route::get('settings/shops/{shop}/settlements/create', [CashbookSettlementController::class, 'create'])->name('settings.shop.settlements.create')->middleware('can:cashbook.settings.manage');
            Route::post('settings/shops/{shop}/settlements', [CashbookSettlementController::class, 'store'])->name('settings.shop.settlements.store')->middleware('can:cashbook.settings.manage');
            Route::get('settings/shops/{shop}/settlements/{settlement}/edit', [CashbookSettlementController::class, 'edit'])->name('settings.shop.settlements.edit')->middleware('can:cashbook.settings.manage');
            Route::put('settings/shops/{shop}/settlements/{settlement}', [CashbookSettlementController::class, 'update'])->name('settings.shop.settlements.update')->middleware('can:cashbook.settings.manage');
            Route::delete('settings/shops/{shop}/settlements/{settlement}', [CashbookSettlementController::class, 'destroy'])->name('settings.shop.settlements.destroy')->middleware('can:cashbook.settings.manage');
            Route::post('settings/shops/{shop}/settlements/{settlement}/copy', [CashbookSettlementController::class, 'copy'])->name('settings.shop.settlements.copy')->middleware('can:cashbook.settings.manage');
            Route::post('settings/shops/{shop}/settlements/{settlement}/set-net-balance', [CashbookSettlementController::class, 'setNetBalance'])->name('settings.shop.settlements.set-net-balance')->middleware('can:cashbook.settings.manage');
            Route::post('settings/shops/{shop}/settlements/{settlement}/set-payment-payable', [CashbookSettlementController::class, 'setDefaultPaymentPayable'])->name('settings.shop.settlements.set-payment-payable')->middleware('can:cashbook.settings.manage');
            Route::post('settings/shops/{shop}/settlements/{settlement}/set-payment-paid', [CashbookSettlementController::class, 'setDefaultPaymentPaid'])->name('settings.shop.settlements.set-payment-paid')->middleware('can:cashbook.settings.manage');

            Route::get('settings/shops/{shop}/payments', [CashbookSettlementController::class, 'paymentsIndex'])->name('settings.shop.payments.index')->middleware('can:cashbook.settings.view');
            Route::post('settings/shops/{shop}/payments-configuration', [CashbookSettlementController::class, 'savePaymentsConfiguration'])->name('settings.shop.payments-configuration.save')->middleware('can:cashbook.settings.manage');
            Route::post('settings/shops/{shop}/payments/company-collections', [CashbookSettlementController::class, 'saveCompanyCollections'])->name('settings.shop.payments.company-collections.save')->middleware('can:cashbook.settings.manage');
            Route::post('settings/shops/{shop}/payments/shop-to-company', [CashbookSettlementController::class, 'saveShopToCompany'])->name('settings.shop.payments.shop-to-company.save')->middleware('can:cashbook.settings.manage');
            Route::post('settings/shops/{shop}/payments/petty', [CashbookSettlementController::class, 'savePetty'])->name('settings.shop.payments.petty.save')->middleware('can:cashbook.settings.manage');
            Route::post('settings/shops/{shop}/payments/settlement', [CashbookSettlementController::class, 'saveSettlement'])->name('settings.shop.payments.settlement.save')->middleware('can:cashbook.settings.manage');
            Route::post('settings/shops/{shop}/payments/allocation', [CashbookSettlementController::class, 'saveAllocation'])->name('settings.shop.payments.allocation.save')->middleware('can:cashbook.settings.manage');
            Route::post('settings/shops/{shop}/payments/report-headings', [CashbookSettlementController::class, 'saveReportHeadings'])->name('settings.shop.payments.report-headings.save')->middleware('can:cashbook.settings.manage');
            Route::post('settings/shops/{shop}/payments/advanced', [CashbookSettlementController::class, 'saveAdvanced'])->name('settings.shop.payments.advanced.save')->middleware('can:cashbook.settings.manage');

            Route::get('settings/salary', [CashbookSalaryController::class, 'rootIndex'])->name('settings.salary')->middleware('can:cashbook.settings.view');
            Route::get('settings/shops/{shop}/salary', [CashbookSalaryController::class, 'index'])->name('settings.shop.salary.index')->middleware('can:cashbook.settings.view');
            Route::post('settings/shops/{shop}/salary', [CashbookSalaryController::class, 'update'])->name('settings.shop.salary.update')->middleware('can:cashbook.settings.manage');
            Route::post('settings/shops/{shop}/salary/reset', [CashbookSalaryController::class, 'resetToDefault'])->name('settings.shop.salary.reset')->middleware('can:cashbook.settings.manage');

            Route::get('settings/shops/{shop}/demo', [CashbookController::class, 'shopDemoPage'])->name('settings.shop.demo')->middleware('can:cashbook.settings.view');
            Route::get('settings/shops/{shop}/demo/real-data', [CashbookController::class, 'shopDemoRealData'])->name('settings.shop.demo.real-data')->middleware('can:cashbook.settings.view');
            Route::get('settings/presets', [CashbookController::class, 'presetsPage'])->name('settings.presets')->middleware('can:cashbook.settings.view');
            Route::get('settings/collections', [CashbookController::class, 'collectionGroupsPage'])->name('settings.collections')->middleware('can:cashbook.settings.view');

            Route::get('finance/purchase/product-filters', [PurchaseProductFilterController::class, 'index'])->name('finance.purchase.product-filters.index')->middleware('can:cashbook.settings.view');
            Route::get('finance/purchase/product-filters/create', [PurchaseProductFilterController::class, 'create'])->name('finance.purchase.product-filters.create')->middleware('can:cashbook.settings.manage');
            Route::post('finance/purchase/product-filters', [PurchaseProductFilterController::class, 'store'])->name('finance.purchase.product-filters.store')->middleware('can:cashbook.settings.manage');
            Route::get('finance/purchase/product-filters/{productFilter:uuid}/edit', [PurchaseProductFilterController::class, 'edit'])->name('finance.purchase.product-filters.edit')->middleware('can:cashbook.settings.manage');
            Route::put('finance/purchase/product-filters/{productFilter:uuid}', [PurchaseProductFilterController::class, 'update'])->name('finance.purchase.product-filters.update')->middleware('can:cashbook.settings.manage');
            Route::delete('finance/purchase/product-filters/{productFilter:uuid}', [PurchaseProductFilterController::class, 'destroy'])->name('finance.purchase.product-filters.destroy')->middleware('can:cashbook.settings.manage');
            Route::get('finance/purchase/product-allotments', [AdminProductPurchaserAllotmentController::class, 'index'])->name('finance.purchase.product-allotments.index')->middleware('can:cashbook.settings.view');
            Route::post('finance/purchase/product-allotments', [AdminProductPurchaserAllotmentController::class, 'store'])->name('finance.purchase.product-allotments.store')->middleware('can:cashbook.settings.manage');
            Route::get('finance/purchase/product-allotments/{product}/history', [AdminProductPurchaserAllotmentController::class, 'history'])->name('finance.purchase.product-allotments.history')->middleware('can:cashbook.settings.view');

            // ── JSON API routes (rate limited & throttled) ─────────────────────
            Route::prefix('api')->middleware('throttle:60,1')->name('api.')->group(function () {
                // Read endpoints
                Route::get('shop-data', [CashbookController::class, 'getShopData'])->name('shop-data')->middleware('can:cashbook.shops.view');
                Route::get('shop-settlement-summary', [CashbookController::class, 'getShopSettlementSummary'])->name('shop-settlement-summary')->middleware('can:cashbook.shops.view');
                Route::get('all-shops-overview', [CashbookController::class, 'getAllShopsOverview'])->name('all-shops-overview')->middleware('can:cashbook.shops.view');
                Route::get('payables-pendings', [CashbookController::class, 'getPayablesAndPendings'])->name('payables-pendings')->middleware('can:cashbook.shops.view');
                Route::get('rules', [CashbookController::class, 'getRules'])->name('rules')->middleware('can:cashbook.shops.view');
                Route::get('company-accounts', [CashbookController::class, 'getCompanyAccounts'])->name('company-accounts')->middleware('can:cashbook.shops.view');
                Route::get('client-summary', [CashbookController::class, 'getClientSummary'])->name('client-summary')->middleware('can:cashbook.shops.view');
                Route::get('report-bills', [CashbookController::class, 'getReportBills'])->name('report-bills')->middleware('can:cashbook.reports.view');
                Route::get('presets', [CashbookController::class, 'getPresets'])->name('presets')->middleware('can:cashbook.settings.view');
                Route::get('products/search', [CashbookController::class, 'searchProducts'])->name('products.search')->middleware('can:cashbook.shops.view');

                // Write endpoints
                Route::post('record-entry', [CashbookController::class, 'recordEntry'])->name('record-entry')->middleware('can:cashbook.shops.manage');
                Route::post('bulk-record-entries', [CashbookController::class, 'bulkRecordEntries'])->name('bulk-record-entries')->middleware('can:cashbook.shops.manage');
                Route::post('update-entry', [CashbookController::class, 'updateEntry'])->name('update-entry')->middleware('can:cashbook.shops.manage');
                Route::post('delete-entry', [CashbookController::class, 'deleteEntry'])->name('delete-entry')->middleware('can:cashbook.shops.manage');
                Route::post('void-entry', [CashbookController::class, 'voidEntry'])->name('void-entry')->middleware('can:cashbook.shops.manage');
                Route::post('approve-entry', [CashbookController::class, 'approveEntry'])->name('approve-entry')->middleware('can:cashbook.shops.manage');
                Route::post('approve-day', [CashbookController::class, 'approveDay'])->name('approve-day')->middleware('can:cashbook.shops.manage');
                Route::post('accept-payment', [CashbookController::class, 'acceptPayment'])->name('accept-payment')->middleware('can:cashbook.shops.manage');
                Route::post('pay-shop', [CashbookController::class, 'payShop'])->name('pay-shop')->middleware('can:cashbook.shops.manage');
                Route::post('add-shop', [CashbookController::class, 'addShop'])->name('add-shop')->middleware('can:cashbook.shops.manage');
                Route::post('update-rule', [CashbookController::class, 'updateRule'])->name('update-rule')->middleware('can:cashbook.settings.manage');
                Route::post('create-rule-config', [CashbookController::class, 'createRuleConfig'])->name('create-rule-config')->middleware('can:cashbook.settings.manage');
                Route::post('toggle-day', [CashbookController::class, 'toggleDay'])->name('toggle-day')->middleware('can:cashbook.settings.manage');
                Route::post('presets/create', [CashbookController::class, 'createPreset'])->name('presets.create')->middleware('can:cashbook.settings.manage');
                Route::post('presets/delete', [CashbookController::class, 'deletePreset'])->name('presets.delete')->middleware('can:cashbook.settings.manage');
                Route::post('presets/create-entry-rule', [CashbookController::class, 'createEntryRule'])->name('presets.create-entry-rule')->middleware('can:cashbook.settings.manage');
                Route::post('presets/collection-group', [CashbookController::class, 'saveCollectionGroup'])->name('presets.collection-group')->middleware('can:cashbook.settings.manage');
                Route::post('presets/update-setting', [CashbookController::class, 'updatePresetSetting'])->name('presets.update-setting')->middleware('can:cashbook.settings.manage');
                Route::post('shop-settings/update', [CashbookController::class, 'updateShopSetting'])->name('shop-settings.update')->middleware('can:cashbook.settings.manage');
                Route::post('shop-settings/toggle-status', [CashbookController::class, 'toggleShopSettingStatus'])->name('shop-settings.toggle-status')->middleware('can:cashbook.settings.manage');
                Route::post('shop-settings/custom-row', [CashbookController::class, 'createShopCustomRow'])->name('shop-settings.custom-row')->middleware('can:cashbook.settings.manage');
                Route::post('shop-settings/headers/create', [CashbookController::class, 'createShopHeaderGroup'])->name('shop-settings.headers.create')->middleware('can:cashbook.settings.manage');
                Route::post('shop-settings/headers/update', [CashbookController::class, 'updateShopHeaderGroup'])->name('shop-settings.headers.update')->middleware('can:cashbook.settings.manage');
                Route::post('shop-settings/headers/delete', [CashbookController::class, 'deleteShopHeaderGroup'])->name('shop-settings.headers.delete')->middleware('can:cashbook.settings.manage');
                Route::post('shop-settings/headers/reorder', [CashbookController::class, 'reorderShopHeaderGroups'])->name('shop-settings.headers.reorder')->middleware('can:cashbook.settings.manage');
                Route::post('shop-settings/assign-header', [CashbookController::class, 'assignSettingToHeaderGroup'])->name('shop-settings.assign-header')->middleware('can:cashbook.settings.manage');
                Route::post('shop-settings/cards/reorder', [CashbookController::class, 'reorderShopHeaderCards'])->name('shop-settings.cards.reorder')->middleware('can:cashbook.settings.manage');
                Route::post('shop-settings/relations/create', [CashbookController::class, 'createShopRelation'])->name('shop-settings.relations.create')->middleware('can:cashbook.settings.manage');
                Route::post('shop-settings/relations/add-item', [CashbookController::class, 'addShopRelationItem'])->name('shop-settings.relations.add-item')->middleware('can:cashbook.settings.manage');
                Route::post('shop-settings/relations/update-item-role', [CashbookController::class, 'updateShopRelationItemRole'])->name('shop-settings.relations.update-item-role')->middleware('can:cashbook.settings.manage');
                Route::post('shop-settings/relations/delete-item', [CashbookController::class, 'deleteShopRelationItem'])->name('shop-settings.relations.delete-item')->middleware('can:cashbook.settings.manage');
                Route::post('shop-settings/relations/delete', [CashbookController::class, 'deleteShopRelation'])->name('shop-settings.relations.delete')->middleware('can:cashbook.settings.manage');
                Route::post('shop-settings/relations/update-settings', [CashbookController::class, 'updateShopRelationSettings'])->name('shop-settings.relations.update-settings')->middleware('can:cashbook.settings.manage');
                Route::post('shop-settings/bank-adjustment-rules', [CashbookController::class, 'saveShopBankAdjustmentRule'])->name('shop-settings.bank-adjustment-rules.save')->middleware('can:cashbook.settings.manage');
                Route::delete('shop-settings/bank-adjustment-rules/{rule}', [CashbookController::class, 'deleteShopBankAdjustmentRule'])->name('shop-settings.bank-adjustment-rules.delete')->middleware('can:cashbook.settings.manage');
                Route::post('shops/{shop}/bank-settlement-adjustments', [CashbookController::class, 'saveShopDailyBankAdjustments'])->name('shops.bank-settlement-adjustments.save')->middleware('can:cashbook.settings.manage');
                Route::post('historical-bank-collections/preview', [CashbookController::class, 'previewHistoricalBankCollections'])->name('historical-bank-collections.preview')->middleware('can:cashbook.settings.manage');
                Route::post('historical-bank-collections/fetch', [CashbookController::class, 'fetchHistoricalBankCollections'])->name('historical-bank-collections.fetch')->middleware('can:cashbook.settings.manage');
                Route::post('assign-preset', [CashbookController::class, 'assignShopPreset'])->name('assign-preset')->middleware('can:cashbook.settings.manage');
            });
        });
