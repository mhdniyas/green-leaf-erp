...
Route::prefix('v1')->middleware('api')->name('api.v1.')->group(function () {
    ...
    Route::middleware('auth:sanctum')->group(function () {
        ...
        Route::prefix('purchasing')->name('purchasing.')->group(function () {
            ...
            Route::get('grns/received-advance-match-candidates', [GoodsReceivedController::class, 'receivedAdvanceMatchCandidates'])->name('grns.received-advance-match-candidates');
            Route::get('grns/unmatched-advance-report', [GoodsReceivedController::class, 'unmatchedAdvanceReport'])->name('grns.unmatched-advance-report');
            ...
            Route::post('grns/{grn}/advance-matches', [GoodsReceivedController::class, 'matchReceivedBillWithAdvance'])->name('grns.advance-matches');
